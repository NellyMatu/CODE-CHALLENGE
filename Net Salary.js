function calculateNHIF(grossPay) {
    if (grossPay <= 5999) {
        ...
        return 1700; // For gross pay of 100,000 and above
    }
}
...
function calculateNSSF(pensionablePay) {
    if (pensionablePay <= 7000) {
        return 0.06 * pensionablePay; // Assuming 6% contribution
    } else if (pensionablePay <= 36000) {
        return 0.06 * (pensionablePay - 7000) + 420; // 420 is 6% of 7000
    } else {
        return 2160; // For pensionable pay above 36,000 (Tier II)
    }
}
...
function calculateTax(annualTaxablePay) {
    if (annualTaxablePay <= 288000) {
        ...
        return (annualTaxablePay - 388000) * 0.3 + 65000;
    } else if (annualTaxablePay <= 9600000) {
        return (annualTaxablePay - 6000000) * 0.325 + 149000;
    } else {
        return (annualTaxablePay - 9600000) * 0.35 + 252500;
    }
}
...
function calculateNetSalary(basicSalary, benefits) {
    ...
    // Calculate tax
    const tax = calculateTax(annualTaxablePay) / 12; // Monthly tax
